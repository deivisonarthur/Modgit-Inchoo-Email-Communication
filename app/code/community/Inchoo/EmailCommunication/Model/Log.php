 ...
 */
class Inchoo_EmailCommunication_Model_Log extends Mage_Core_Model_Abstract
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'inchoo_email_communication';
    ...
    {
        $this->_init('inchoo_email_communication/log');
    }
}