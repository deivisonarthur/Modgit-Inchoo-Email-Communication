...
class Inchoo_EmailCommunication_Model_Core_Email_Template extends Mage_Core_Model_Email_Template
{
    public function send($email, $name = null, array $variables = array())
    {
        ...
        if ($emailCommunication->getConfigEnabled() == true) {
            ...
            if($emailCommunication->getConfigSsl() != '')
            {
                $config['ssl'] = $emailCommunication->getConfigSsl();
            }
            if(!$emailCommunication->getConfigName() != '')
            {
                $config['name'] = $emailCommunication->getConfigName();
            }
